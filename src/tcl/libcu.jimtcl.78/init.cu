...
__host_device__ int Jim_bootstrapInit(Jim_Interp *interp) {
...
__host_device__ int Jim_initjimshInit(Jim_Interp *interp) {
...
__host_device__ int Jim_globInit(Jim_Interp *interp) {
...
__host_device__ int Jim_stdlibInit(Jim_Interp *interp) {
...
__host_device__ int Jim_tclcompatInit(Jim_Interp *interp) {
