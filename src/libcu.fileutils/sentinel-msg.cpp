...
extern "C" bool sentinelFileUtilsExecutor(void *tag, sentinelMessage *data, int length, char *(**hostPrepare)(void*, char*, char*, intptr_t)) {
	...
	case FILEUTILS_GETGRNAM: { fileutils_getgrnam *msg = (fileutils_getgrnam *)data; msg->RC = dchgrp_getgrnam(msg->Str); return true; }
	...
	case FILEUTILS_GETPWNAM: { fileutils_getpwnam *msg = (fileutils_getpwnam *)data; msg->RC = dchown_getpwnam_(msg->Str); return true; }
	...
	case FILEUTILS_ISADIR: { fileutils_isadir *msg = (fileutils_isadir *)data; msg->RC = dcp_isadir_(msg->Str); return true; }
